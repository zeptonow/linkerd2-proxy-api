...
type HttpLocalConcurrencyLimit struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	...
	MaxInFlightRequests uint32 `protobuf:"varint,2,opt,name=max_in_flight_requests,json=maxInFlightRequests,proto3" json:"max_in_flight_requests,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}

func (x *HttpLocalConcurrencyLimit) Reset() {
	*x = HttpLocalConcurrencyLimit{}
	mi := &file_inbound_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *HttpLocalConcurrencyLimit) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HttpLocalConcurrencyLimit) ProtoMessage() {}

func (x *HttpLocalConcurrencyLimit) ProtoReflect() protoreflect.Message {
	mi := &file_inbound_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HttpLocalConcurrencyLimit.ProtoReflect.Descriptor instead.
func (*HttpLocalConcurrencyLimit) Descriptor() ([]byte, []int) {
	return file_inbound_proto_rawDescGZIP(), []int{11}
}

func (x *HttpLocalConcurrencyLimit) GetMetadata() *meta.Metadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *HttpLocalConcurrencyLimit) GetMaxInFlightRequests() uint32 {
	if x != nil {
...
type ProxyProtocol_Detect struct {
	...
	HttpLocalConcurrencyLimit *HttpLocalConcurrencyLimit `protobuf:"bytes,5,opt,name=http_local_concurrency_limit,json=httpLocalConcurrencyLimit,proto3" json:"http_local_concurrency_limit,omitempty"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
...
func (x *ProxyProtocol_Detect) GetHttpLocalConcurrencyLimit() *HttpLocalConcurrencyLimit {
	if x != nil {
		return x.HttpLocalConcurrencyLimit
	}
	return nil
}
...
type ProxyProtocol_Http1 struct {
	...
	LocalConcurrencyLimit *HttpLocalConcurrencyLimit `protobuf:"bytes,4,opt,name=local_concurrency_limit,json=localConcurrencyLimit,proto3" json:"local_concurrency_limit,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *ProxyProtocol_Http1) GetLocalConcurrencyLimit() *HttpLocalConcurrencyLimit {
	if x != nil {
		return x.LocalConcurrencyLimit
	}
	return nil
}
...
func (x *ProxyProtocol_Http2) GetLocalConcurrencyLimit() *HttpLocalConcurrencyLimit {
	if x != nil {
		return x.LocalConcurrencyLimit
	}
	return nil
...
func (x *HttpLocalRateLimit_Override_ClientIdentities) Reset() {
	*x = HttpLocalRateLimit_Override_ClientIdentities{}
	mi := &file_inbound_proto_msgTypes[29]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_inbound_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xa1\v\n" +
	"\rProxyProtocol\x12H\n" +
	...
	"\x04grpc\x18\x06 \x01(\v2,.io.linkerd.proxy.inbound.ProxyProtocol.GrpcH\x00R\x04grpc\x1a\xe0\x02\n" +
	"\x06Detect\x123\n" +
	...
	"httpRoutes\x12_\n" +
	"\x15http_local_rate_limit\x18\x04 \x01(\v2,.io.linkerd.proxy.inbound.HttpLocalRateLimitR\x12httpLocalRateLimit\x12t\n" +
	"\x1chttp_local_concurrency_limit\x18\x05 \x01(\v23.io.linkerd.proxy.inbound.HttpLocalConcurrencyLimitR\x19httpLocalConcurrencyLimitJ\x04\b\x02\x10\x03\x1a\x8f\x02\n" +
	"\x05Http1\x12;\n" +
	"\x06routes\x18\x02 \x03(\v2#.io.linkerd.proxy.inbound.HttpRouteR\x06routes\x12V\n" +
	"\x10local_rate_limit\x18\x03 \x01(\v2,.io.linkerd.proxy.inbound.HttpLocalRateLimitR\x0elocalRateLimit\x12k\n" +
	"\x17local_concurrency_limit\x18\x04 \x01(\v23.io.linkerd.proxy.inbound.HttpLocalConcurrencyLimitR\x15localConcurrencyLimitJ\x04\b\x01\x10\x02\x1a\x8f\x02\n" +
	"\x05Http2\x12;\n" +
	"\x06routes\x18\x02 \x03(\v2#.io.linkerd.proxy.inbound.HttpRouteR\x06routes\x12V\n" +
	"\x10local_rate_limit\x18\x03 \x01(\v2,.io.linkerd.proxy.inbound.HttpLocalRateLimitR\x0elocalRateLimit\x12k\n" +
	"\x17local_concurrency_limit\x18\x04 \x01(\v23.io.linkerd.proxy.inbound.HttpLocalConcurrencyLimitR\x15localConcurrencyLimitJ\x04\b\x01\x10\x02\x1aI\n" +
	"\x04Grpc\x12;\n" +
	...
	"identities\x1a5\n" +
	"\x05Limit\x12,\n" +
	"\x11requestsPerSecond\x18\x01 \x01(\rR\x11requestsPerSecond\"\x8d\x01\n" +
	"\x19HttpLocalConcurrencyLimit\x12;\n" +
	"\bmetadata\x18\x01 \x01(\v2\x1f.io.linkerd.proxy.meta.MetadataR\bmetadata\x123\n" +
	"\x16max_in_flight_requests\x18\x02 \x01(\rR\x13maxInFlightRequests2\xc1\x01\n" +
...
var file_inbound_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
var file_inbound_proto_goTypes = []any{
	...
	(*HttpLocalConcurrencyLimit)(nil),   // 11: io.linkerd.proxy.inbound.HttpLocalConcurrencyLimit
	nil,                                 // 12: io.linkerd.proxy.inbound.Server.LabelsEntry
	(*ProxyProtocol_Detect)(nil),        // 13: io.linkerd.proxy.inbound.ProxyProtocol.Detect
	(*ProxyProtocol_Http1)(nil),         // 14: io.linkerd.proxy.inbound.ProxyProtocol.Http1
	(*ProxyProtocol_Http2)(nil),         // 15: io.linkerd.proxy.inbound.ProxyProtocol.Http2
	(*ProxyProtocol_Grpc)(nil),          // 16: io.linkerd.proxy.inbound.ProxyProtocol.Grpc
	(*ProxyProtocol_Opaque)(nil),        // 17: io.linkerd.proxy.inbound.ProxyProtocol.Opaque
	(*ProxyProtocol_Tls)(nil),           // 18: io.linkerd.proxy.inbound.ProxyProtocol.Tls
	nil,                                 // 19: io.linkerd.proxy.inbound.Authz.LabelsEntry
	(*Authn_PermitUnauthenticated)(nil), // 20: io.linkerd.proxy.inbound.Authn.PermitUnauthenticated
	(*Authn_PermitMeshTLS)(nil),         // 21: io.linkerd.proxy.inbound.Authn.PermitMeshTLS
	(*Authn_PermitMeshTLS_PermitClientIdentities)(nil),   // 22: io.linkerd.proxy.inbound.Authn.PermitMeshTLS.PermitClientIdentities
	(*HttpRoute_Rule)(nil),                               // 23: io.linkerd.proxy.inbound.HttpRoute.Rule
	(*HttpRoute_Filter)(nil),                             // 24: io.linkerd.proxy.inbound.HttpRoute.Filter
	(*GrpcRoute_Rule)(nil),                               // 25: io.linkerd.proxy.inbound.GrpcRoute.Rule
	(*GrpcRoute_Filter)(nil),                             // 26: io.linkerd.proxy.inbound.GrpcRoute.Filter
	(*HttpLocalRateLimit_Override)(nil),                  // 27: io.linkerd.proxy.inbound.HttpLocalRateLimit.Override
	(*HttpLocalRateLimit_Limit)(nil),                     // 28: io.linkerd.proxy.inbound.HttpLocalRateLimit.Limit
	(*HttpLocalRateLimit_Override_ClientIdentities)(nil), // 29: io.linkerd.proxy.inbound.HttpLocalRateLimit.Override.ClientIdentities
	(*net.IPAddress)(nil),                                // 30: io.linkerd.proxy.net.IPAddress
	(*meta.Metadata)(nil),                                // 31: io.linkerd.proxy.meta.Metadata
	(*net.IPNetwork)(nil),                                // 32: io.linkerd.proxy.net.IPNetwork
	(*http_route.HostMatch)(nil),                         // 33: io.linkerd.proxy.http_route.HostMatch
	(*duration.Duration)(nil),                            // 34: google.protobuf.Duration
	(*http_route.HttpRouteMatch)(nil),                    // 35: io.linkerd.proxy.http_route.HttpRouteMatch
	(*http_route.HttpFailureInjector)(nil),               // 36: io.linkerd.proxy.http_route.HttpFailureInjector
	(*http_route.RequestHeaderModifier)(nil),             // 37: io.linkerd.proxy.http_route.RequestHeaderModifier
	(*http_route.RequestRedirect)(nil),                   // 38: io.linkerd.proxy.http_route.RequestRedirect
	(*grpc_route.GrpcRouteMatch)(nil),                    // 39: io.linkerd.proxy.grpc_route.GrpcRouteMatch
	(*grpc_route.GrpcFailureInjector)(nil),               // 40: io.linkerd.proxy.grpc_route.GrpcFailureInjector
}
var file_inbound_proto_depIdxs = []int32{
	...
	30, // 1: io.linkerd.proxy.inbound.Server.server_ips:type_name -> io.linkerd.proxy.net.IPAddress
	3,  // 2: io.linkerd.proxy.inbound.Server.authorizations:type_name -> io.linkerd.proxy.inbound.Authz
	12, // 3: io.linkerd.proxy.inbound.Server.labels:type_name -> io.linkerd.proxy.inbound.Server.LabelsEntry
	13, // 4: io.linkerd.proxy.inbound.ProxyProtocol.detect:type_name -> io.linkerd.proxy.inbound.ProxyProtocol.Detect
	17, // 5: io.linkerd.proxy.inbound.ProxyProtocol.opaque:type_name -> io.linkerd.proxy.inbound.ProxyProtocol.Opaque
	18, // 6: io.linkerd.proxy.inbound.ProxyProtocol.tls:type_name -> io.linkerd.proxy.inbound.ProxyProtocol.Tls
	14, // 7: io.linkerd.proxy.inbound.ProxyProtocol.http1:type_name -> io.linkerd.proxy.inbound.ProxyProtocol.Http1
	15, // 8: io.linkerd.proxy.inbound.ProxyProtocol.http2:type_name -> io.linkerd.proxy.inbound.ProxyProtocol.Http2
	16, // 9: io.linkerd.proxy.inbound.ProxyProtocol.grpc:type_name -> io.linkerd.proxy.inbound.ProxyProtocol.Grpc
	...
	19, // 12: io.linkerd.proxy.inbound.Authz.labels:type_name -> io.linkerd.proxy.inbound.Authz.LabelsEntry
	31, // 13: io.linkerd.proxy.inbound.Authz.metadata:type_name -> io.linkerd.proxy.meta.Metadata
	32, // 14: io.linkerd.proxy.inbound.Network.net:type_name -> io.linkerd.proxy.net.IPNetwork
	32, // 15: io.linkerd.proxy.inbound.Network.except:type_name -> io.linkerd.proxy.net.IPNetwork
	20, // 16: io.linkerd.proxy.inbound.Authn.unauthenticated:type_name -> io.linkerd.proxy.inbound.Authn.PermitUnauthenticated
	21, // 17: io.linkerd.proxy.inbound.Authn.meshTLS:type_name -> io.linkerd.proxy.inbound.Authn.PermitMeshTLS
	31, // 18: io.linkerd.proxy.inbound.HttpRoute.metadata:type_name -> io.linkerd.proxy.meta.Metadata
	33, // 19: io.linkerd.proxy.inbound.HttpRoute.hosts:type_name -> io.linkerd.proxy.http_route.HostMatch
	3,  // 20: io.linkerd.proxy.inbound.HttpRoute.authorizations:type_name -> io.linkerd.proxy.inbound.Authz
	23, // 21: io.linkerd.proxy.inbound.HttpRoute.rules:type_name -> io.linkerd.proxy.inbound.HttpRoute.Rule
	31, // 22: io.linkerd.proxy.inbound.GrpcRoute.metadata:type_name -> io.linkerd.proxy.meta.Metadata
	33, // 23: io.linkerd.proxy.inbound.GrpcRoute.hosts:type_name -> io.linkerd.proxy.http_route.HostMatch
	3,  // 24: io.linkerd.proxy.inbound.GrpcRoute.authorizations:type_name -> io.linkerd.proxy.inbound.Authz
	25, // 25: io.linkerd.proxy.inbound.GrpcRoute.rules:type_name -> io.linkerd.proxy.inbound.GrpcRoute.Rule
	31, // 26: io.linkerd.proxy.inbound.HttpLocalRateLimit.metadata:type_name -> io.linkerd.proxy.meta.Metadata
	28, // 27: io.linkerd.proxy.inbound.HttpLocalRateLimit.total:type_name -> io.linkerd.proxy.inbound.HttpLocalRateLimit.Limit
	28, // 28: io.linkerd.proxy.inbound.HttpLocalRateLimit.identity:type_name -> io.linkerd.proxy.inbound.HttpLocalRateLimit.Limit
	27, // 29: io.linkerd.proxy.inbound.HttpLocalRateLimit.overrides:type_name -> io.linkerd.proxy.inbound.HttpLocalRateLimit.Override
	31, // 30: io.linkerd.proxy.inbound.HttpLocalConcurrencyLimit.metadata:type_name -> io.linkerd.proxy.meta.Metadata
	34, // 31: io.linkerd.proxy.inbound.ProxyProtocol.Detect.timeout:type_name -> google.protobuf.Duration
	8,  // 32: io.linkerd.proxy.inbound.ProxyProtocol.Detect.http_routes:type_name -> io.linkerd.proxy.inbound.HttpRoute
	10, // 33: io.linkerd.proxy.inbound.ProxyProtocol.Detect.http_local_rate_limit:type_name -> io.linkerd.proxy.inbound.HttpLocalRateLimit
	11, // 34: io.linkerd.proxy.inbound.ProxyProtocol.Detect.http_local_concurrency_limit:type_name -> io.linkerd.proxy.inbound.HttpLocalConcurrencyLimit
	8,  // 35: io.linkerd.proxy.inbound.ProxyProtocol.Http1.routes:type_name -> io.linkerd.proxy.inbound.HttpRoute
	10, // 36: io.linkerd.proxy.inbound.ProxyProtocol.Http1.local_rate_limit:type_name -> io.linkerd.proxy.inbound.HttpLocalRateLimit
	11, // 37: io.linkerd.proxy.inbound.ProxyProtocol.Http1.local_concurrency_limit:type_name -> io.linkerd.proxy.inbound.HttpLocalConcurrencyLimit
	8,  // 38: io.linkerd.proxy.inbound.ProxyProtocol.Http2.routes:type_name -> io.linkerd.proxy.inbound.HttpRoute
	10, // 39: io.linkerd.proxy.inbound.ProxyProtocol.Http2.local_rate_limit:type_name -> io.linkerd.proxy.inbound.HttpLocalRateLimit
	11, // 40: io.linkerd.proxy.inbound.ProxyProtocol.Http2.local_concurrency_limit:type_name -> io.linkerd.proxy.inbound.HttpLocalConcurrencyLimit
	9,  // 41: io.linkerd.proxy.inbound.ProxyProtocol.Grpc.routes:type_name -> io.linkerd.proxy.inbound.GrpcRoute
	20, // 42: io.linkerd.proxy.inbound.Authn.PermitMeshTLS.unauthenticated:type_name -> io.linkerd.proxy.inbound.Authn.PermitUnauthenticated
	22, // 43: io.linkerd.proxy.inbound.Authn.PermitMeshTLS.identities:type_name -> io.linkerd.proxy.inbound.Authn.PermitMeshTLS.PermitClientIdentities
	6,  // 44: io.linkerd.proxy.inbound.Authn.PermitMeshTLS.PermitClientIdentities.identities:type_name -> io.linkerd.proxy.inbound.Identity
	7,  // 45: io.linkerd.proxy.inbound.Authn.PermitMeshTLS.PermitClientIdentities.suffixes:type_name -> io.linkerd.proxy.inbound.IdentitySuffix
	35, // 46: io.linkerd.proxy.inbound.HttpRoute.Rule.matches:type_name -> io.linkerd.proxy.http_route.HttpRouteMatch
	24, // 47: io.linkerd.proxy.inbound.HttpRoute.Rule.filters:type_name -> io.linkerd.proxy.inbound.HttpRoute.Filter
	36, // 48: io.linkerd.proxy.inbound.HttpRoute.Filter.failure_injector:type_name -> io.linkerd.proxy.http_route.HttpFailureInjector
	37, // 49: io.linkerd.proxy.inbound.HttpRoute.Filter.request_header_modifier:type_name -> io.linkerd.proxy.http_route.RequestHeaderModifier
	38, // 50: io.linkerd.proxy.inbound.HttpRoute.Filter.redirect:type_name -> io.linkerd.proxy.http_route.RequestRedirect
	39, // 51: io.linkerd.proxy.inbound.GrpcRoute.Rule.matches:type_name -> io.linkerd.proxy.grpc_route.GrpcRouteMatch
	26, // 52: io.linkerd.proxy.inbound.GrpcRoute.Rule.filters:type_name -> io.linkerd.proxy.inbound.GrpcRoute.Filter
	40, // 53: io.linkerd.proxy.inbound.GrpcRoute.Filter.failure_injector:type_name -> io.linkerd.proxy.grpc_route.GrpcFailureInjector
	37, // 54: io.linkerd.proxy.inbound.GrpcRoute.Filter.request_header_modifier:type_name -> io.linkerd.proxy.http_route.RequestHeaderModifier
	28, // 55: io.linkerd.proxy.inbound.HttpLocalRateLimit.Override.limit:type_name -> io.linkerd.proxy.inbound.HttpLocalRateLimit.Limit
	29, // 56: io.linkerd.proxy.inbound.HttpLocalRateLimit.Override.clients:type_name -> io.linkerd.proxy.inbound.HttpLocalRateLimit.Override.ClientIdentities
	6,  // 57: io.linkerd.proxy.inbound.HttpLocalRateLimit.Override.ClientIdentities.identities:type_name -> io.linkerd.proxy.inbound.Identity
	0,  // 58: io.linkerd.proxy.inbound.InboundServerPolicies.GetPort:input_type -> io.linkerd.proxy.inbound.PortSpec
	0,  // 59: io.linkerd.proxy.inbound.InboundServerPolicies.WatchPort:input_type -> io.linkerd.proxy.inbound.PortSpec
	1,  // 60: io.linkerd.proxy.inbound.InboundServerPolicies.GetPort:output_type -> io.linkerd.proxy.inbound.Server
	1,  // 61: io.linkerd.proxy.inbound.InboundServerPolicies.WatchPort:output_type -> io.linkerd.proxy.inbound.Server
